...
public class Commands {
   ...
   public int performPrefixedCommand(CommandSourceStack p_230958_, String p_230959_) {
      return this.performCommand(p_230958_, p_230959_.startsWith("/") ? p_230959_.substring(1) : p_230959_);
   }

   public int performCommand(CommandSourceStack p_82118_, String p_82119_) {
      StringReader stringreader = new StringReader(p_82119_);
      p_82118_.getServer().getProfiler().push(() -> {
         return "/" + p_82119_;
      });
      ...
      try {
         try {
            ...
            p_82118_.sendFailure(Component.translatable("command.failed").withStyle((p_82137_) -> {
               return p_82137_.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, mutablecomponent));
            }));
            if (SharedConstants.IS_RUNNING_IN_IDE) {
               p_82118_.sendFailure(Component.literal(Util.describeError(exception)));
