...
public class ArgumentTypeInfos {
   ...
   public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> p_235385_) {
      ...
      register(p_235385_, "particle", ParticleArgument.class, SingletonArgumentInfo.contextFree(ParticleArgument::particle));
      ...
      register(p_235385_, "mob_effect", MobEffectArgument.class, SingletonArgumentInfo.contextFree(MobEffectArgument::effect));
      ...
      register(p_235385_, "item_enchantment", ItemEnchantmentArgument.class, SingletonArgumentInfo.contextFree(ItemEnchantmentArgument::enchantment));
      register(p_235385_, "entity_summon", EntitySummonArgument.class, SingletonArgumentInfo.contextFree(EntitySummonArgument::id));
      register(p_235385_, "dimension", DimensionArgument.class, SingletonArgumentInfo.contextFree(DimensionArgument::dimension));
      register(p_235385_, "time", TimeArgument.class, SingletonArgumentInfo.contextFree(TimeArgument::time));
      register(p_235385_, "resource_or_tag", fixClassType(ResourceOrTagLocationArgument.class), new ResourceOrTagLocationArgument.Info<Object>());
      register(p_235385_, "resource", fixClassType(ResourceKeyArgument.class), new ResourceKeyArgument.Info<Object>());
   ...
   public static <A extends ArgumentType<?>> ArgumentTypeInfo<A, ?> byClass(A p_235383_) {
      ...
      if (argumenttypeinfo == null) {
         throw new IllegalArgumentException("Unrecognized argument type %s (%s)".formatted(p_235383_, p_235383_.getClass()));
      } else {
