...
public class DataFixers {
   ...
   private static synchronized DataFixer createFixerUpper() {
      ...
      boolean flag = flag1;
      SharedConstants.DATAFIXER_OPTIMIZATION_OPTION = flag ? DataFixerOptimizationOption.INITIALIZED_OPTIMIZED : DataFixerOptimizationOption.INITIALIZED_UNOPTIMIZED;
      LOGGER.info("Building {} datafixer", (Object)(flag ? "optimized" : "unoptimized"));
      return flag ? datafixerbuilder.buildOptimized(Util.bootstrapExecutor()) : datafixerbuilder.buildUnoptimized();
   }
   ...
   private static void addFixers(DataFixerBuilder p_14514_) {
      ...
      p_14514_.addFixer(new OminousBannerRenameFix(schema91));
      ...
      p_14514_.addFixer(ItemRenameFix.create(schema98, "Rename bee_hive item to beehive", unaryoperator));
      p_14514_.addFixer(new PoiTypeRenameFix(schema98, "Rename bee_hive poi to beehive", unaryoperator));
      p_14514_.addFixer(BlockRenameFix.create(schema98, "Rename bee_hive block to beehive", unaryoperator));
      ...
      Schema schema155 = p_14514_.addSchema(3076, V3076::new);
      p_14514_.addFixer(new AddNewChoices(schema155, "Added Sculk Catalyst", References.BLOCK_ENTITY));
      Schema schema156 = p_14514_.addSchema(3077, SAME_NAMESPACED);
      p_14514_.addFixer(new ChunkDeleteIgnoredLightDataFix(schema156));
      Schema schema157 = p_14514_.addSchema(3078, V3078::new);
      p_14514_.addFixer(new AddNewChoices(schema157, "Added Frog", References.ENTITY));
      p_14514_.addFixer(new AddNewChoices(schema157, "Added Tadpole", References.ENTITY));
      p_14514_.addFixer(new AddNewChoices(schema157, "Added Sculk Shrieker", References.BLOCK_ENTITY));
      Schema schema158 = p_14514_.addSchema(3081, V3081::new);
      p_14514_.addFixer(new AddNewChoices(schema158, "Added Warden", References.ENTITY));
      Schema schema159 = p_14514_.addSchema(3082, V3082::new);
      p_14514_.addFixer(new AddNewChoices(schema159, "Added Chest Boat", References.ENTITY));
      Schema schema160 = p_14514_.addSchema(3083, V3083::new);
      p_14514_.addFixer(new AddNewChoices(schema160, "Added Allay", References.ENTITY));
      Schema schema161 = p_14514_.addSchema(3084, SAME_NAMESPACED);
      p_14514_.addFixer(new SimpleRenameFix(schema161, References.GAME_EVENT_NAME, ImmutableMap.<String, String>builder().put("minecraft:block_press", "minecraft:block_activate").put("minecraft:block_switch", "minecraft:block_activate").put("minecraft:block_unpress", "minecraft:block_deactivate").put("minecraft:block_unswitch", "minecraft:block_deactivate").put("minecraft:drinking_finish", "minecraft:drink").put("minecraft:elytra_free_fall", "minecraft:elytra_glide").put("minecraft:entity_damaged", "minecraft:entity_damage").put("minecraft:entity_dying", "minecraft:entity_die").put("minecraft:entity_killed", "minecraft:entity_die").put("minecraft:mob_interact", "minecraft:entity_interact").put("minecraft:ravager_roar", "minecraft:entity_roar").put("minecraft:ring_bell", "minecraft:block_change").put("minecraft:shulker_close", "minecraft:container_close").put("minecraft:shulker_open", "minecraft:container_open").put("minecraft:wolf_shaking", "minecraft:entity_shake").build()));
      Schema schema162 = p_14514_.addSchema(3086, SAME_NAMESPACED);
      p_14514_.addFixer(new EntityVariantFix(schema162, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), (p_216528_) -> {
      ...
      p_14514_.addFixer(new CriteriaRenameFix(schema162, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (p_216517_) -> {
         return immutablemap3.getOrDefault(p_216517_, p_216517_);
      }));
      Schema schema163 = p_14514_.addSchema(3087, SAME_NAMESPACED);
      p_14514_.addFixer(new EntityVariantFix(schema163, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), (p_216519_) -> {
         p_216519_.put(0, "minecraft:temperate");
         p_216519_.put(1, "minecraft:warm");
         p_216519_.put(2, "minecraft:cold");
      })::get));
      Schema schema164 = p_14514_.addSchema(3088, SAME_NAMESPACED);
      p_14514_.addFixer(new BlendingDataFix(schema164));
      Schema schema165 = p_14514_.addSchema(3090, SAME_NAMESPACED);
      p_14514_.addFixer(new EntityPaintingFieldsRenameFix(schema165));
      ...
      p_14514_.addFixer(new CriteriaRenameFix(schema168, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (p_216531_) -> {
         return map.getOrDefault(p_216531_, p_216531_);
      }));
      p_14514_.addFixer(new PoiTypeRemoveFix(schema168, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
   }
