...
public class Gui extends GuiComponent {
   ...
   public Gui(Minecraft p_232355_, ItemRenderer p_232356_) {
      ...
      this.chatListeners = List.of(new StandardChatListener(p_232355_), NarratorChatListener.INSTANCE, new OverlayChatListener(p_232355_));
   ...
   public void setNowPlaying(Component p_93056_) {
      this.setOverlayMessage(Component.translatable("record.nowPlaying", p_93056_), true);
   }
   ...
   public void handlePlayerChat(ChatType p_232361_, Component p_232362_, ChatSender p_232363_) {
      if (!this.minecraft.isBlocked(p_232363_.uuid())) {
         if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.guessChatUUID(p_232362_))) {
            for(ChatListener chatlistener : this.chatListeners) {
               chatlistener.handle(p_232361_, p_232362_, p_232363_);
            }
   ...
   public void handleSystemChat(ChatType p_232358_, Component p_232359_) {
      if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.guessChatUUID(p_232359_))) {
         for(ChatListener chatlistener : this.chatListeners) {
            chatlistener.handle(p_232358_, p_232359_, (ChatSender)null);
         }
