...
public class Options {
   ...
   private final OptionInstance<Double> chatDelay = new OptionInstance<>("options.chat.delay_instant", OptionInstance.noTooltip(), (p_232030_, p_232031_) -> {
      return p_232031_ <= 0.0D ? Component.translatable("options.chat.delay_none") : Component.translatable("options.chat.delay", String.format("%.1f", p_232031_));
   ...
   private final OptionInstance<Double> mouseWheelSensitivity = new OptionInstance<>("options.mouseWheelSensitivity", OptionInstance.noTooltip(), (p_232013_, p_232014_) -> {
      return genericValueLabel(p_232013_, Component.literal(String.format("%.2f", p_232014_)));
   ...
   private final OptionInstance<NarratorStatus> narrator = new OptionInstance<>("options.narrator", OptionInstance.noTooltip(), (p_231907_, p_231908_) -> {
      return (Component)(NarratorChatListener.INSTANCE.isActive() ? p_231908_.getName() : Component.translatable("options.narrator.notavailable"));
      ...
      NarratorChatListener.INSTANCE.updateNarratorStatus(p_231860_);
   });
   ...
   private void processOptions(Options.FieldAccess p_168428_) {
      ...
      p_168428_.process("chatPreview", this.chatPreview);
      ...
      for(SoundSource soundsource : SoundSource.values()) {
         this.sourceVolumes.computeFloat(soundsource, (p_231866_, p_231867_) -> {
            return p_168428_.process("soundCategory_" + p_231866_.getName(), p_231867_ != null ? p_231867_ : 1.0F);
         });
      }
