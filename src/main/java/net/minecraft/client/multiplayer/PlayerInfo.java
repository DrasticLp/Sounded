...
public class PlayerInfo {
   ...
   public PlayerInfo(ClientboundPlayerInfoPacket.PlayerUpdate p_233762_, SignatureValidator p_233763_) {
      ...
      try {
         ...
         if (profilepublickey$data != null) {
            profilepublickey = ProfilePublicKey.createValidated(p_233763_, profilepublickey$data);
         }
      } catch (InsecurePublicKeyException | CryptException cryptexception) {
         LOGGER.error("Failed to retrieve publicKey property for profile {}", this.profile.getId(), cryptexception);
      }
