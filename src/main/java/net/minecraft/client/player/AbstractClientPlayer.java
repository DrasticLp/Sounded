...
public abstract class AbstractClientPlayer extends Player {
   ...
   public static void registerSkinTexture(ResourceLocation p_172522_, String p_172523_) {
      ...
      if (abstracttexture == MissingTextureAtlasSprite.getTexture()) {
         AbstractTexture httptexture = new HttpTexture((File)null, String.format("http://skins.minecraft.net/MinecraftSkins/%s.png", StringUtil.stripColor(p_172523_)), DefaultPlayerSkin.getDefaultSkin(UUIDUtil.createOfflinePlayerUUID(p_172523_)), true, (Runnable)null);
